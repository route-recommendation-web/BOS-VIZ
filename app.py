...
def network_graph(lon,lat):
    ...
    ############################################################################################################################################################
    npc_trace = go.Scatter(x=tuple([lon/MAX_X, None]), y=tuple([lat/MAX_Y, None]),  marker={'size': 15, 'color': 'Black'},hovertext=["NPC"], mode='markers+text', textposition="bottom center",
                            hoverinfo="text",)
    traceRecode.append(npc_trace)
    ############################################################################################################################################################
        ...
        children=[
                    ...
                    html.Div(
                        ...
                        children=[
                            ...
                            **Start Location**
                            ...
                            Input the xy coordinate.
                            """)),
                            dcc.Input(id="inputx", type="text", placeholder="-71.14"),
                            dcc.Input(id="inputy", type="text", placeholder="42.32"),
                            # html.Div(id="output")
                        ],
                        style={'height': '300px'}
                    )
            ...
            html.Div(
                ...
                children=[dcc.Graph(id="my-graph",
                                    figure=network_graph(-71.14, 42.32))],
            ),
...
@app.callback(
    ...
    [dash.dependencies.Input('inputx', 'x'), dash.dependencies.Input('inputy', 'y')])
def update_output(x,y):
    return network_graph(x, y)
